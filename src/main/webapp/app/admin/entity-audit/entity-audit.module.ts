...
import { DiscourcesSharedModule } from 'app/shared/shared.module';
...
@NgModule({
  imports: [CommonModule, DiscourcesSharedModule, DiffMatchPatchModule, RouterModule.forChild([entityAuditRoute])],
