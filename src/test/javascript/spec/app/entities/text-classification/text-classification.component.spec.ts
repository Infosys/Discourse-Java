...
import { TextClassificationComponent } from 'app/entities/text-classification/text-classification.component';
...
describe('Component Tests', () => {
  describe('TextClassification Management Component', () => {
    let comp: TextClassificationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TextClassificationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TextClassification(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.textClassifications && comp.textClassifications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
