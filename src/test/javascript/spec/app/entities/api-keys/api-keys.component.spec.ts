...
import { ApiKeysComponent } from 'app/entities/api-keys/api-keys.component';
import { ApiKeysService } from 'app/entities/api-keys/api-keys.service';
import { ApiKeys } from 'app/shared/model/api-keys.model';

describe('Component Tests', () => {
  describe('ApiKeys Management Component', () => {
    let comp: ApiKeysComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApiKeysComponent, '')
        .compileComponents();
