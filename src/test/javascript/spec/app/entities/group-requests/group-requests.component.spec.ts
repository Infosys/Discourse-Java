...
import { GroupRequestsComponent } from 'app/entities/group-requests/group-requests.component';
...
describe('Component Tests', () => {
  describe('GroupRequests Management Component', () => {
    let comp: GroupRequestsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GroupRequestsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.groupRequests && comp.groupRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
