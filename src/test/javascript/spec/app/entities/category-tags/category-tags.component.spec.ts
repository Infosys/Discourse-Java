...
import { CategoryTagsComponent } from 'app/entities/category-tags/category-tags.component';
...
describe('Component Tests', () => {
  describe('CategoryTags Management Component', () => {
    let comp: CategoryTagsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryTagsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoryTags && comp.categoryTags[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
