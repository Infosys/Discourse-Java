...
import { UploadsComponent } from 'app/entities/uploads/uploads.component';
import { UploadsService } from 'app/entities/uploads/uploads.service';
import { Uploads } from 'app/shared/model/uploads.model';

describe('Component Tests', () => {
  describe('Uploads Management Component', () => {
    let comp: UploadsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UploadsComponent, '')
        .compileComponents();
