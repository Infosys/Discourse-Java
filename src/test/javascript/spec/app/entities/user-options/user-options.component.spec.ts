...
import { UserOptionsComponent } from 'app/entities/user-options/user-options.component';
...
describe('Component Tests', () => {
  describe('UserOptions Management Component', () => {
    let comp: UserOptionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserOptionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userOptions && comp.userOptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
