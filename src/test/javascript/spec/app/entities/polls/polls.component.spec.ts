...
import { PollsComponent } from 'app/entities/polls/polls.component';
import { PollsService } from 'app/entities/polls/polls.service';
import { Polls } from 'app/shared/model/polls.model';

describe('Component Tests', () => {
  describe('Polls Management Component', () => {
    let comp: PollsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PollsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.polls && comp.polls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
