...
import { ThemesComponent } from 'app/entities/themes/themes.component';
import { ThemesService } from 'app/entities/themes/themes.service';
import { Themes } from 'app/shared/model/themes.model';

describe('Component Tests', () => {
  describe('Themes Management Component', () => {
    let comp: ThemesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ThemesComponent, '')
        .compileComponents();
