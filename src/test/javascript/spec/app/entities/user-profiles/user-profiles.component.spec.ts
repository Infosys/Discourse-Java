...
import { UserProfilesComponent } from 'app/entities/user-profiles/user-profiles.component';
...
describe('Component Tests', () => {
  describe('UserProfiles Management Component', () => {
    let comp: UserProfilesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserProfilesComponent, '')
        .compileComponents();
