...
import { CategoryUsersComponent } from 'app/entities/category-users/category-users.component';
...
describe('Component Tests', () => {
  describe('CategoryUsers Management Component', () => {
    let comp: CategoryUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryUsersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoryUsers && comp.categoryUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
