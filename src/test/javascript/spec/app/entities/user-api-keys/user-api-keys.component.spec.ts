...
import { UserApiKeysComponent } from 'app/entities/user-api-keys/user-api-keys.component';
...
describe('Component Tests', () => {
  describe('UserApiKeys Management Component', () => {
    let comp: UserApiKeysComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserApiKeysComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userApiKeys && comp.userApiKeys[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
