...
import { UserWarningsComponent } from 'app/entities/user-warnings/user-warnings.component';
...
describe('Component Tests', () => {
  describe('UserWarnings Management Component', () => {
    let comp: UserWarningsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserWarningsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userWarnings && comp.userWarnings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
