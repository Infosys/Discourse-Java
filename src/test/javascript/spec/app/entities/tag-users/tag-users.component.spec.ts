...
import { TagUsersComponent } from 'app/entities/tag-users/tag-users.component';
...
describe('Component Tests', () => {
  describe('TagUsers Management Component', () => {
    let comp: TagUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TagUsersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tagUsers && comp.tagUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
