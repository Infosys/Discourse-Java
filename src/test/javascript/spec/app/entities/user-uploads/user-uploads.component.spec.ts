...
import { UserUploadsComponent } from 'app/entities/user-uploads/user-uploads.component';
...
describe('Component Tests', () => {
  describe('UserUploads Management Component', () => {
    let comp: UserUploadsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserUploadsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userUploads && comp.userUploads[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
