...
import { PollVotesComponent } from 'app/entities/poll-votes/poll-votes.component';
...
describe('Component Tests', () => {
  describe('PollVotes Management Component', () => {
    let comp: PollVotesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PollVotesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pollVotes && comp.pollVotes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
