...
import { UserEmailsComponent } from 'app/entities/user-emails/user-emails.component';
...
describe('Component Tests', () => {
  describe('UserEmails Management Component', () => {
    let comp: UserEmailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserEmailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userEmails && comp.userEmails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
