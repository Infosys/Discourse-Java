...
import { UserHistoriesComponent } from 'app/entities/user-histories/user-histories.component';
...
describe('Component Tests', () => {
  describe('UserHistories Management Component', () => {
    let comp: UserHistoriesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserHistoriesComponent, '')
        .compileComponents();
