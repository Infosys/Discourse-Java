...
import { EmailLogsComponent } from 'app/entities/email-logs/email-logs.component';
...
describe('Component Tests', () => {
  describe('EmailLogs Management Component', () => {
    let comp: EmailLogsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmailLogsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.emailLogs && comp.emailLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
