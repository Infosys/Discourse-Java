...
import { UserBadgesComponent } from 'app/entities/user-badges/user-badges.component';
...
describe('Component Tests', () => {
  describe('UserBadges Management Component', () => {
    let comp: UserBadgesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserBadgesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userBadges && comp.userBadges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
