...
import { UserActionsComponent } from 'app/entities/user-actions/user-actions.component';
...
describe('Component Tests', () => {
  describe('UserActions Management Component', () => {
    let comp: UserActionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserActionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userActions && comp.userActions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
