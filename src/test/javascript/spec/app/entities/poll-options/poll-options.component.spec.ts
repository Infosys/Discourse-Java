...
import { PollOptionsComponent } from 'app/entities/poll-options/poll-options.component';
...
describe('Component Tests', () => {
  describe('PollOptions Management Component', () => {
    let comp: PollOptionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PollOptionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pollOptions && comp.pollOptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
