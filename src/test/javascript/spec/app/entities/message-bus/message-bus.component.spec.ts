...
import { MessageBusComponent } from 'app/entities/message-bus/message-bus.component';
...
describe('Component Tests', () => {
  describe('MessageBus Management Component', () => {
    let comp: MessageBusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MessageBusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.messageBuses && comp.messageBuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
