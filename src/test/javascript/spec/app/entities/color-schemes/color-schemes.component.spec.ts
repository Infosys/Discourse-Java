...
import { ColorSchemesComponent } from 'app/entities/color-schemes/color-schemes.component';
...
describe('Component Tests', () => {
  describe('ColorSchemes Management Component', () => {
    let comp: ColorSchemesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ColorSchemesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.colorSchemes && comp.colorSchemes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
