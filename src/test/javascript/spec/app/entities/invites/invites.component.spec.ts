...
import { InvitesComponent } from 'app/entities/invites/invites.component';
import { InvitesService } from 'app/entities/invites/invites.service';
import { Invites } from 'app/shared/model/invites.model';

describe('Component Tests', () => {
  describe('Invites Management Component', () => {
    let comp: InvitesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InvitesComponent, '')
        .compileComponents();
