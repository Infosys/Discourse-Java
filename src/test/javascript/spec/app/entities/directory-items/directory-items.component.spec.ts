...
import { DirectoryItemsComponent } from 'app/entities/directory-items/directory-items.component';
...
describe('Component Tests', () => {
  describe('DirectoryItems Management Component', () => {
    let comp: DirectoryItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DirectoryItemsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.directoryItems && comp.directoryItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
