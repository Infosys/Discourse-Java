...
import { InvitedGroupsComponent } from 'app/entities/invited-groups/invited-groups.component';
...
describe('Component Tests', () => {
  describe('InvitedGroups Management Component', () => {
    let comp: InvitedGroupsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InvitedGroupsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.invitedGroups && comp.invitedGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
