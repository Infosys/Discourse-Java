...
import { MutedUsersComponent } from 'app/entities/muted-users/muted-users.component';
...
describe('Component Tests', () => {
  describe('MutedUsers Management Component', () => {
    let comp: MutedUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MutedUsersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mutedUsers && comp.mutedUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
