...
import { UserStatsComponent } from 'app/entities/user-stats/user-stats.component';
...
describe('Component Tests', () => {
  describe('UserStats Management Component', () => {
    let comp: UserStatsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserStatsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userStats && comp.userStats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
