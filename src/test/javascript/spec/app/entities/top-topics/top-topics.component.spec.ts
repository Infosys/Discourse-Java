...
import { TopTopicsComponent } from 'app/entities/top-topics/top-topics.component';
...
describe('Component Tests', () => {
  describe('TopTopics Management Component', () => {
    let comp: TopTopicsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TopTopicsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.topTopics && comp.topTopics[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
