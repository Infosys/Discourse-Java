...
import { ApplicationRequestsComponent } from 'app/entities/application-requests/application-requests.component';
...
describe('Component Tests', () => {
  describe('ApplicationRequests Management Component', () => {
    let comp: ApplicationRequestsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplicationRequestsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ApplicationRequests(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.applicationRequests && comp.applicationRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
