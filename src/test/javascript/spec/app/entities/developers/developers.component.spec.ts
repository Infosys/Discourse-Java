...
import { DevelopersComponent } from 'app/entities/developers/developers.component';
...
describe('Component Tests', () => {
  describe('Developers Management Component', () => {
    let comp: DevelopersComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.developers && comp.developers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
