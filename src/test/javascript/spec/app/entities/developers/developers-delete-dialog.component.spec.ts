...
import { DevelopersDeleteDialogComponent } from 'app/entities/developers/developers-delete-dialog.component';
import { DevelopersService } from 'app/entities/developers/developers.service';

describe('Component Tests', () => {
  describe('Developers Management Delete Component', () => {
    let comp: DevelopersDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DevelopersDeleteDialogComponent, '')
        .compileComponents();
