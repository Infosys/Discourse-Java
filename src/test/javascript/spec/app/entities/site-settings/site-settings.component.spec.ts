...
import { SiteSettingsComponent } from 'app/entities/site-settings/site-settings.component';
...
describe('Component Tests', () => {
  describe('SiteSettings Management Component', () => {
    let comp: SiteSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SiteSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.siteSettings && comp.siteSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
