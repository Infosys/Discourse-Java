  ...
  describe('Drafts Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DraftsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.drafts && comp.drafts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
