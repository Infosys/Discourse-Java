...
import { AnnouncmentComponent } from 'app/entities/announcment/announcment.component';
...
describe('Component Tests', () => {
  describe('Announcment Management Component', () => {
    let comp: AnnouncmentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AnnouncmentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.announcments && comp.announcments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
