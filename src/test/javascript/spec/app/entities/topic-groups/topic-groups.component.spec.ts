...
import { TopicGroupsComponent } from 'app/entities/topic-groups/topic-groups.component';
...
describe('Component Tests', () => {
  describe('TopicGroups Management Component', () => {
    let comp: TopicGroupsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TopicGroupsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.topicGroups && comp.topicGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
