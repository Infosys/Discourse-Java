...
import { InvitedUsersComponent } from 'app/entities/invited-users/invited-users.component';
...
describe('Component Tests', () => {
  describe('InvitedUsers Management Component', () => {
    let comp: InvitedUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InvitedUsersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.invitedUsers && comp.invitedUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
