...
import { UserVisitsComponent } from 'app/entities/user-visits/user-visits.component';
...
describe('Component Tests', () => {
  describe('UserVisits Management Component', () => {
    let comp: UserVisitsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserVisitsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userVisits && comp.userVisits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
